...
vlog -vlog01compat -work work +incdir+D:/Desktop/FPGA/QuartusII/4.select {D:/Desktop/FPGA/QuartusII/4.select/select.v}

vlog -vlog01compat -work work +incdir+D:/Desktop/FPGA/QuartusII/4.select {D:/Desktop/FPGA/QuartusII/4.select/select_tb.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver -L rtl_work -L work -voptargs="+acc"  select_tb
